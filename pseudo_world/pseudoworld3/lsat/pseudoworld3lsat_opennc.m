...
inname = 'world_3_historical_pseudo_world_1850-2005_lsat_1961-1990.nc';
inpath = [indir inname];
...
PW3.uncorr_2d = reshape(PW3.uncorr, [nloc ntime]);
PW3.uncorr_2d = PW3.uncorr_2d';
PW3.uncorr_2d = double(PW3.uncorr_2d);
