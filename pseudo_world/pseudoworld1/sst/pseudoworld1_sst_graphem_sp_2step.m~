% pseudoworld1_sst_graphem_sp_2step.m
...
indir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld1/data/';
...
onepath = [odir 'pseudoworld1_sst_graphem_sp' num2str(target_spars*100) '_step1.mat'];
%twoname = 'pseudoworld1_sst_graphem_cr800_step2.mat';
twopath = [odir 'pseudoworld1_sst_graphem_sp' num2str(target_spars*100) '_step2.mat'];

adjdir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld1/sst/data/';
adjtag = [adjdir 'pseudoworld1_sst_adj_sp' num2str(target_spars*100) '.mat'];
load(adjtag)
