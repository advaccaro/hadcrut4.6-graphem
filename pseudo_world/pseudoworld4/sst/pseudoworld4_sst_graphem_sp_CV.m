...
Xraw = raw.PW4_sst.grid_2d; %raw 2D data matrix (w/ missing vals)
Xraw = center(Xraw); [ntime,nspace] = size(Xraw);
loc = raw.PW4_sst.loc; lats = loc(:,2);
lats_2d = repmat(lats, [1 ntime]);
lats_2d = lats_2d'; %time x space


%Load infilled example to obtain useful meta data
infilled = load('pseudoworld4_sst_graphem_sp25_step2.mat');
index = infilled.PW4_sst.ocean; %index of non-empty grid points
...
savedir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld4/sst/data/';
savetag = 'pseudoworld4_sst_CVscores10.mat';
