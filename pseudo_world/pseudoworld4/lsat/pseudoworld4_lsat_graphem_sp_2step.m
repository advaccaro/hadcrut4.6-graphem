% pseudoworld4_lsat_graphem_sp_2step.m
...
inpath = [indir inname];
odir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld4/lsat/data/';
%oname = 'pseudoworld4_lsat_graphem_cr800.mat';
%opath = [odir oname];
%onename = 'pseudoworld4_lsat_graphem_cr800_step1.mat';
onepath = [odir 'pseudoworld4_lsat_graphem_sp' num2str(target_spars*100) '_step1.mat'];
%twoname = 'pseudoworld4_lsat_graphem_cr800_step2.mat';
twopath = [odir 'pseudoworld4_lsat_graphem_sp' num2str(target_spars*100) '_step2.mat'];

adjdir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld4/lsat/data/';
adjtag = [adjdir 'pseudoworld4_lsat_adj_sp' num2str(target_spars*100) '.mat'];
load(adjtag)
