% pseudoworld2_lsat_graphem_sp_2step.m
...
onepath = [odir 'pseudoworld2_lsat_graphem_sp' num2str(target_spars*100) '_step1.mat'];
%twoname = 'pseudoworld2_lsat_graphem_cr800_step2.mat';
twopath = [odir 'pseudoworld2_lsat_graphem_sp' num2str(target_spars*100) '_step2.mat'];

adjdir = '/home/scec-02/avaccaro/HadCRUT4.2/pseudo_world/pseudoworld2/lsat/data/';
adjtag = [adjdir 'pseudoworld2_lsat_adj_sp' num2str(target_spars*100) '.mat'];
load(adjtag)
