%pseudoworld2sst_graphem_sp_step0.m
...
load('pseudoworld2_sst.mat')
sst_f = PW2_sst.grid_2d;
ocean = ~isnan(sst_f(1,:));
sst_o = sst_f(:,ocean);


tser = double(PW2_sst.time) + datenum('1850-1-1');
tvec = datevec(tser);
...
for k = 1:nvals
	...
	adjtag = [odir 'PW2_sst_adj_sp' num2str(target_spars*100) '.mat'];
