% pseudoworld2_sst_graphem_sp_2step.m
...
indir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld2/data/';
inname = 'pseudoworld2_sst.mat';
inpath = [indir inname];
odir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld2/sst/data/';
%oname = 'pseudoworld2_sst_graphem_cr800.mat';
%opath = [odir oname];
%onename = 'pseudoworld2_sst_graphem_cr800_step1.mat';
onepath = [odir 'pseudoworld2_sst_graphem_sp' num2str(target_spars*100) '_step1.mat'];
%twoname = 'pseudoworld2_sst_graphem_cr800_step2.mat';
twopath = [odir 'pseudoworld2_sst_graphem_sp' num2str(target_spars*100) '_step2.mat'];

adjdir = '/home/geovault-02/avaccaro/hadcrut4.6-graphem/pseudo_world/pseudoworld2/sst/data/';
adjtag = [adjdir 'pseudoworld2_sst_adj_sp' num2str(target_spars*100) '.mat'];
load(adjtag)
