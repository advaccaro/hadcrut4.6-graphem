...
export SLURM_FILENAME="RUN_had46ens_graphem_merra_krig_sp60_file$1.txt"
export OUT_FILENAME="had46ens_graphem_merra_krig_sp60_file$1"
...
echo "cd /home/geovault-02/avaccaro/hadcrut4.6-graphem/ensemble/" >> $SLURM_FILENAME

echo "/usr/bin/matlab -nodesktop -nosplash > ./out/$OUT_FILENAME.out << EOF" >> $SLURM_FILENAME
echo "filenum = $FILE_NUM" >> $SLURM_FILENAME
echo "had46ens_graphem_merra_krig_sp60_main" >> $SLURM_FILENAME
